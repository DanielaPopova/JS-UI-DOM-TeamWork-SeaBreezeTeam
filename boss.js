...
function preload() {
    ...
    game.load.spritesheet('boss', 'assets/boss.png', 200, 200);
...
function create() {
    ...
    // Adding PESHO, baddie and the boss
     ...
     boss = game.add.sprite(game.world.width - 580, game.world.height - 160, 'boss');
    ...
    game.add.tween(boss).to({ y: 300 }, 700, Phaser.Easing.Quadratic.InOut, true, 0, 1000, true);
...
function update() {
  //  PESHO and platforms -need group from Stoyan
    ...
    game.physics.arcade.collide(boss, platforms);
      ...
      game.physics.arcade.collide(player, boss, takeDamage, null, this);
